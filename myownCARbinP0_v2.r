 ...
 nk = cnew3$TotalPop
  ...
  M = 1000      # M*Nskip = 1000 takes about 45 sec;    a quality run would be M = 5000, Nskip = 20?
  Nskip = 100
  burnin = M*0.2 
...
plot(betahist[50:M,1],betahist[50:M,2], col=rgb((50:M)/M,0, 1 - (50:M)/M))
  ...
  ##  CI output 
   ...
   TotDhist = 1.15* c (mean(TotD0hist[rnge]), mean(TotD10hist[rnge]), mean(TotD20hist[rnge]),
   ...
   CI.TotD = 1.15* t(cbind(CI.TotD0, CI.TotD10, CI.TotD20, CI.TotD30, CI.TotD40,
